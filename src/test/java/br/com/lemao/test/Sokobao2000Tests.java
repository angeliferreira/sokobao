...
import br.com.lemao.test.utils.LevelTest;
import br.com.lemao.test.utils.Utils;
...
public class Sokobao2000Tests {
	...
	public void tryToPassBlockThroughWallMovingEast() {
		Sokobao sokobao = new Sokobao(LevelTest.gridTemplateLevel1MovingHeroNorth1CellEast3CellsAndHeroMoveBlockEast2Cells());
	...
	public void tryToPassBlockThroughWallMovingWest() {
		Sokobao sokobao = new Sokobao(LevelTest.gridTemplateLevel1MovingHeroEast2CellsNorth2CellsAndHeroMoveBlockWest2Cells());
	...
	public void tryToPassBlockThroughWallMovingNorth() {
		Sokobao sokobao = new Sokobao(LevelTest.gridTemplateLevel1MovingHeroEast1CellNorth1CellAndHeroMoveBlockNorth1Cell());
	...
	public void tryToPassBlockThroughWallMovingSouth() {
		Sokobao sokobao = new Sokobao(LevelTest.gridTemplateLevel1MovingHeroEast2CellsSouth1CellAndHeroMoveBlockSouth2Cells());
	...
	public void tryToPassBlockThroughAnotherBlockMovingEast() {
		Sokobao sokobao = new Sokobao(LevelTest.gridTemplateLevel1WithHorizontalPositioningHeroBlockBlock());
	...
	public void tryToPassBlockThroughAnotherBlockMovingWest() {
		Sokobao sokobao = new Sokobao(LevelTest.gridTemplateLevel1WithHorizontalPositioningBlockBlockHero());
	...
	public void tryToPassBlockThroughAnotherBlockMovingNorth() {
		Sokobao sokobao = new Sokobao(LevelTest.gridTemplateLevel1WithVerticalPositioningBlockBlockHero());
	...
	public void tryToPassBlockThroughAnotherBlockMovingSouth() {
		Sokobao sokobao = new Sokobao(LevelTest.gridTemplateLevel1WithVerticalPositioningHeroBlockBlock());
	...
	public void passBlockThroughTargetMovingEast() {
		Sokobao sokobao = new Sokobao(LevelTest.gridTemplateLevel1WithHorizontalPositioningHeroBlockTarget());
	...
	public void passBlockThroughTargetMovingWest() {
		Sokobao sokobao = new Sokobao(LevelTest.gridTemplateLevel1WithHorizontalPositioningTargetBlockHero());
	...
	public void passBlockThroughTargetMovingNorth() {
		Sokobao sokobao = new Sokobao(LevelTest.gridTemplateLevel1WithVerticalPositioningTargetBlockHero());
	...
	public void passBlockThroughTargetMovingSouth() {
		Sokobao sokobao = new Sokobao(LevelTest.gridTemplateLevel1WithVerticalPositioningHeroBlockTarget());
